...
> **当前状态：阶段 10（自动化测试补强）已完成，Debug/Release 38/38 通过。
> 当前开发入口是阶段 11：真实验收。**
...
当前 `MediaHub.exe` 已提供文件菜单、音视频输出区域、打开、播放、暂停、停止、
全屏、进度拖动、音量、静音、状态提示和播放列表。选择本地媒体后会自动开始播放；
播放列表支持多选、拖放、双击切换、移除、上一首/下一首以及顺序/列表循环/单曲循环。
命令行可以一次传入多个本地媒体路径。
